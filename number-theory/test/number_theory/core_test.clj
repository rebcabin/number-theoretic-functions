...
(deftest utilities-test
  (let []
    (is (thrown? java.lang.AssertionError (gcd 0 0)))
    (is (thrown? java.lang.AssertionError (gcd 0 42)))
    (is (thrown? java.lang.AssertionError (gcd 42 0)))
    ...
    (is (thrown? java.lang.AssertionError (integer-power 0 -42)))
    (is (thrown? java.lang.AssertionError (integer-power 15 -42)))
    (is (= 1 (gcd 3 5)))
    (is (= 1 (gcd 3 5 7)))
    (is (= 5 (gcd 5 15)))
    (is (= 5 (gcd 5 15 45)))))
